...
DriverSpecs.mock_driver "Crestron::OccupancySensor" do
  ...
  # expect authentication - the driver only schedules it 1 second after
  # connect, which races the default 1 second expectation timeout
  expect_http_request(timeout: 5.seconds) do |request, response|
